...
public class Item{
	...
	/**
	 * getContents: returns the items in the inventory of an item
	 * if it is openable. If it is not openable, it will return null.
	 */
   ...
   /**
	* displayContents: if an item is openable, it will return all 
	* the contents within the inventory of the item.
	*/
	...
	/**
	 * isOpenable: returns if item is openable
	 */
	...
	/**
	 * setWeight: assign value for the weight of an item
	 */
	public void setWeight(int weight){
		this.weight = weight; 
	}
	/**
	 * getWeight: returns the weight of an item
	 */
	...
	/**
	 * canPickUp: if items weight is less than or equal
	 * to 4, that means it can pick up, and it will return 
	 * true. If the weight is greater, it will return false 
	 */
